...
app.get('/pais', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, res.send(data).end()];
    });
}); });
...
var horario = new Date(Date.UTC(2012, 11, 12, 3, 0, 0));
var prueba = console.log(horario);
